            ...
            {hasWa && (
              <div className="mt-3 flex justify-center sm:justify-end">
                <a
                  ...
                  target="_blank"
                  rel="noopener"
                  className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-2 text-xs font-medium uppercase tracking-wide text-white transition hover:bg-[#20BA5A]"
                >
                  <svg viewBox="0 0 448 512" fill="currentColor" width="15" height="15" aria-hidden="true">
