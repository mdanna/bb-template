...
export const adminTranslations = {
  it: {
    ...
    nav: {
      ...
      groupSite: "Il tuo sito",
      groupSettings: "Impostazioni",
      rules: "Regole di prenotazione",
      payments: "Pagamenti",
      access: "Accessi",
      sync: "Sincronizzazione calendari",
    ...
    images: {
      ...
      legend: "★ principale   ▦ galleria",
      publishing: "Immagine in pubblicazione, comparirà tra pochi istanti…",
    },
    // Dashboard
    dashboard: {
      title: "Dashboard",
  ...
  en: {
    ...
    images: {
      ...
      legend: "★ hero   ▦ gallery",
      publishing: "Publishing image, it will appear shortly…",
    },
    dashboard: {
      title: "Dashboard",
  ...
  es: {
    ...
    images: {
      ...
      legend: "★ principal   ▦ galería",
      publishing: "Publicando la imagen, aparecerá en breve…",
    },
    dashboard: {
  ...
  fr: {
    ...
    nav: {
      groupManage: "Gestion",
      groupSite: "Votre site",
      groupSettings: "Réglages",
      rules: "Règles de réservation",
      payments: "Paiements",
      access: "Accès",
      sync: "Synchronisation des calendriers",
      title: "Administration",
      calendar: "Calendrier",
      policy: "Politique",
      contents: "Contenus",
    ...
    images: {
      ...
      legend: "★ hero   ▦ galerie",
      publishing: "Publication de l'image, elle apparaîtra sous peu…",
    },
    dashboard: {
...
export type AdminTranslation = {
  ...
  images: { title: string; intro: string; upload: string; uploading: string; delete: string; deleting: string; noImages: string; hero: string; gallery: string; order: string; moveLeft: string; moveRight: string; legend: string; publishing: string };
